        ...
        <section id="services" className="dark:bg-dark-main sm:p-10 lg:p-20 p-5">
            ...
            <div className="sm:container mx-auto mt-4">
                ...
                <div className="text-center mt-8">
                    ...
                    <a
                        href="#contact"
                        className="mt-4 inline-block px-6 py-2 textWhite bg-green-500 hover:bg-green-600 rounded transition duration-300"
                    >
                        Get in Touch
                    </a>
                </div>
