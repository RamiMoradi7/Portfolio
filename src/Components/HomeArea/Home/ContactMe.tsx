                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="sm:w-1/2 w-full px-4 mb-8 sm:mb-0 dark:bg-dark-second bg-gray-50">
                        ...
                        <div className="mb-8">
                            ...
                            <a className="text-gray-600  dark:text-gray-400 mt-2 block hover:underline" href="mailto:Ramimoradilg4@gmail.com">
                        ...
                        <div className="mb-8">
                            <div className="flex items-center">
                                ...
                                <p className="pl-2 font-body font-bold uppercase text-grey-40 lg:text-lg dark:text-dark-txt">My Address</p>
                            </div>
